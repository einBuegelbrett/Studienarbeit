...
\begin{itemize}
	...
	\item \textbf{Abschluss:} Fertigstellung der Einleitung und Vorbereitung des praktischen Teils.
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item 2. a) Grundlagen der Sensorik und Hardware.
		\item 2. b) Grundlagen der Datenverarbeitung.
	\end{itemize}
...
\textbf{Ziele:}
\begin{itemize}
	\item Durchführung der Anforderungsanalyse (3. a)).
	\item Auswahl und Integration der Hardware-Komponenten (3. b)).
	\item Dokumentation der Systemkomponenten und des Aufbaus.
	\item \textbf{Abschluss:} Fertigstellung der Abschnitte 3 a) und 3. b).
\end{itemize}
...
\textbf{Ziele:}
\begin{itemize}
	\item Implementierung des Datenbankmodells (3. c)).
	\item Entwicklung von Visualisierungstools (3.c)).
	\item Konzeption und Training des Machine-Learning-Modells (3. d)).
	\item Validierung der Modelle.
	\item \textbf{Abschluss:} Fertigstellung der Abschnitte 3. c) und 3. d).
\end{itemize}
...
\textbf{Ziele:}
\begin{itemize}
	\item Erstellung des Prototyps (3. e)).
	...
	\item \textbf{Abschluss:} Fertigstellung des Kapitels 3.
\end{itemize}
...
\textbf{Ziele:}
\begin{itemize}
	\item Interpretation der Testergebnisse (4. a)).
