...
\def\meinTitel{Erkennung von Bewegungen mittels Python und Sensoren}
...
\def\projektBetreuer{Alfred Becker}
\def\abgabeDatum{12.06.2025}
%-----------------------------------------------------------------------------------
...
%-------------------------------------------------------
\renewcommand\lstlistingname{Codeblöckeverzeichnis}
\renewcommand\lstlistlistingname{Codeblöckeverzeichnis}
...
Diese Arbeit beschäftigt sich mit der Erkennung menschlicher Bewegungen mithilfe von Sensorik und maschinellem Lernen. Ziel ist die Entwicklung eines Systems, das Bewegungsarten wie Gehen, Laufen und Rennen zuverlässig klassifizieren kann. Dazu werden ein Arduino Nano 33 BLE REV2 mit integrierter IMU sowie ein Raspberry Pi 4 zur Datenverarbeitung verwendet. Die Sensoren erfassen Beschleunigungs-, Rotations- und Magnetfeldwerte, die über Bluetooth an den Rechner übertragen werden. Die Daten werden aufbereitet, in Zeitpakete segmentiert und mittels Random-Forest-Modell klassifiziert. Trotz Herausforderungen wie Energieversorgung, Sensorplatzierung oder individueller Bewegungsmuster konnte das entwickelte System eine hohe Genauigkeit von 95\% bei der Klassifikation erzielen. Die Ergebnisse zeigen, dass die Kombination aus geeigneter Hardware und maschinellem Lernen ein effektives Mittel zur Bewegungsanalyse darstellt.
\newpage
...
%********************************
\begin{acronym}[ATT MTU]
	\acro{BLE}{Bluetooth Low Energy}
	\acro{IMU}{Inertial Measurement Unit}
	\acro{ML}{Machine Learning}
	\acro{ATT MTU}{Attribute Protocol Maximum Transmission Unit}
...
%Bewegung
%********************************
\include{chapters/bewegung/bewegung.tex}
\pagebreak

%********************************
%Technische Grundlagen
%********************************
\include{chapters/TechnischeGrundlagen/TechnischeGrundlagen.tex}
\pagebreak

%********************************
%Schwierigkeiten
%********************************
\include{chapters/schwierigkeiten/schwierigkeiten.tex}
\pagebreak

\include{chapters/prototypErstellungTestphase/prototypErstellungTestphase.tex}
\pagebreak

\include{chapters/Testphase/testphase.tex}

%********************************
%Machine Learning
%********************************
\include{chapters/machineLearning/machineLearning.tex}
\pagebreak

%********************************
%Ergebnis
%********************************
\include{chapters/ergebnis/ergebnis.tex}
\pagebreak

%********************************
%Zusammenfassung und Ausblick
%********************************
\include{chapters/reflexion/reflexion.tex}
\pagebreak
