...
\begin{table}[H]
	...
	\begin{tabular}{c c c c}
		...
		\hline
	\end{tabular}
	\caption{Vergleich verschiedener Samplingraten und Messzeiten}
...
Am Ende fiel die Entscheidung bewusst auf die Kombination aus 500ms Intervall und 125s Dauer. Ausschlaggebend war hierbei vor allem die niedrige Verlustquote. Das \ac{ML}-Modell soll später in der Lage sein, die Bewegung anhand eines 5-Sekunden-Fensters zuverlässig zu klassifizieren \cite{jsss-13-187-2024}. Wenn innerhalb dieses Zeitfensters jedoch ein oder mehrere Datenpakete fehlen, könnte das zu Fehlklassifikationen führen, was unsere Hypothese direkt beeinträchtigt.\\
...
Die Wahl eines \ac{UUID}-Primärschlüssels erlaubt die eindeutige Zuordnung jedes Pakets, unabhängig von Quellgerät oder Zeit. Die Normalisierung der Sensorachsen nach Typ (Beschleunigung, Gyroskop, Magnetfeld) unterstützt spätere Auswertungen, etwa zur Bewegungserkennung oder Achsensymmetrie.
